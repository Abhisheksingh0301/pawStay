...
db.serialize(() => {
 ...
 `);
  ...
  CREATE TABLE IF NOT EXISTS providers (
    ...
    profile_picture TEXT,
    pet_category TEXT NOT NULL CHECK (pet_category IN ('Dog', 'Cat', 'Rabbit', 'Bird', 'Fish', 'Other')),
 ...
 `);
  ...
  CREATE TABLE IF NOT EXISTS pets (
    ...
    pet_type TEXT NOT NULL CHECK (pet_type IN ('Dog', 'Cat', 'Rabbit', 'Bird', 'Fish', 'Other')),
    breed TEXT,
